...
abstract class AddVendorPanelBuilder extends State<AddVendorPanel> {
  ...
  final TextEditingController rManagerMobileNumberController =
      TextEditingController();
  final TextEditingController rAlterManagerNameController =
      TextEditingController();
  ...
  Widget get pAlternateMobileNumberField => Expanded(
    child: CustomOptionalField(
      spacing: 10,
      controller: rAlterMobileNumberController,
      validator: (value) {
        if (value!.isNotEmpty || RegExp(Regex.phone).hasMatch(value)) {
  ...
  Widget get companyMobileField => Expanded(
    child: GeneralOptionalField(
      ...
      validator: (value) {
        ...
        if (!RegExp(Regex.phone).hasMatch(value)) {
          return 'Name must be 3-30 characters and contain only letters and spaces';
        }
        return null;
      },
      inputFormatters: [
  ...
  Widget get ownerNameField => Expanded(
    child: GeneralOptionalField(
      ...
      keyboardType: TextInputType.text,
      // Prevent digits; allow letters, spaces and common name punctuation
      inputFormatters: [
        FilteringTextInputFormatter.deny(RegExp(r'\d')),
        // LengthLimitingTextInputFormatter(30),
      ],
  ...
  Widget vendorInfoSectionTablet() {
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 30),
          child: Row(children: [companyNameField, companyMobileField]),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 30),
          child: Row(
  ...
  //   child: Padding(
  //     padding: const EdgeInsets.all(12.0),
  //     child: AlternateMobile(controller: oAlterMobileNumberController),
  //   ),
  // );

  // Widget get rAlternateMobileNumberField => Expanded(
  //   child: Padding(
  //     padding: const EdgeInsets.all(12.0),
  //     child: AlternateMobile(controller: rAlterManagerNameController),
  //   ),
  // );
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      TextFieldlabelText("Representative Name"),
                      formTextFieldVendor(
                        '[a-zA-Z ]+',
                        "",
                        [],
