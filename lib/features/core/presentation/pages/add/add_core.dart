...
import 'package:indogrip/features/core/presentation/pages/add/add_core_builder.dart';

class AddCorePanel extends StatefulWidget {
  const AddCorePanel({super.key});
  static const String routeName = '/addCore';

  @override
  State<AddCorePanel> createState() => _AddCorePanelState();
}

class _AddCorePanelState extends AddCoreBuilder {
  @override
          ...
          child: Shortcuts(
            ...
            child: Actions(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    DesktopAppBar(context, statekey, 'Add Core', false),
                    SizedBox(height: 30),
