...
class _PrintStickerState extends State<PrintSticker> {
                  ...
                  return batchDetailsModel.status == 1
                      ? Column(
                          children: [
                            ...
                            Expanded(child: stickersWidget(batchDetailsModel)),
                          ],
                        )
                      : Center(
                          child: Text(
                            batchDetailsModel.message ?? '',
                            style: TextStyle(
                              color: Colors.grey.shade600,
                              fontSize: 16,
                            ),
  ...
  // Widget barcodeWidget(String? barcodeText) => Container(
  ...
  //             ),
  //             child: BarcodeWidget(
  //               barcode: Barcode.fromType(selectedType),
  //               data: data.isEmpty ? "123456789012" : data,
  //               width: 300,
  //               height: 150,
  //               color: Colors.black,
  //               backgroundColor: Colors.white,
  //               errorBuilder: (context, error) => const Text('Invalid barcode data'),
  //             ),
  //           );
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: BarcodeWidget(
                                    ...
                                    data:
                                        '${batchDetailsModel.record?.batchInformation?.batchScanCode ?? ""}$displayIndex',
                                    width: 300,
                                    height: 60,
                                    color: Colors.black,
                                    backgroundColor: Colors.white,
                                    errorBuilder: (context, error) =>
                                        const Text('Invalid barcode data'),
                                  ),
                                ),
