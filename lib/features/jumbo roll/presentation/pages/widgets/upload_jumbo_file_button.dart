...
class UploadJumboFileButton extends StatefulWidget {
  const UploadJumboFileButton({super.key});

  @override
  State<UploadJumboFileButton> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<UploadJumboFileButton> {
  ...
  Widget get uploadButton => Padding(
    ...
    child: BlocConsumer(
      ...
      listener: (context, state) {
        if (state is UploadJumboCSVFileSuccessState) {
