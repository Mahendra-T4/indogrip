...
class RoundSearchFields extends ConsumerStatefulWidget {
  RoundSearchFields({
    super.key,
    this.status,
    this.statusValue,
  ...
  // final Function(dynamic)? onStockStatusChanged;
  final String searchHint;
  final Widget? panelStatus;

  @override
  ConsumerState<RoundSearchFields> createState() => _SearchFieldsState();
}

class _SearchFieldsState extends ConsumerState<RoundSearchFields> {
      ...
      child: Responsive.isDesktop(context)
          ? Row(
              ...
              children: [
                ...
                Expanded(
                  child: StockStatus(onChanged: widget.onChangedStatus!),
                ),
                //     : SizedBox.shrink(),
