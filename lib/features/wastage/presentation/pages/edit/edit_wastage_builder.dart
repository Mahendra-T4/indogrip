...
abstract class EditWastageBuilder extends State<EditWastagePanel> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ClientsListDropdown(
                    ...
                    value: clientName,
                    onChanged: (val) => setState(() => clientName = val),
                  ),
                ],
              ),
            ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  TextFieldlabelText("Total Price"),
                  Container(
                      ...
                      wastageBloc.add(
                        AddWastageONRecordEvent(
                          addWastageParam: AddWastageParam(
                            ...
                            price_kg: totalPriceController.text,
