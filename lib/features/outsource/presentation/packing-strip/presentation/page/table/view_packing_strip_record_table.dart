...
class ViewStripRecordTablePanel extends StatefulWidget {
  const ViewStripRecordTablePanel({super.key});
  static const String routeName = '/outsource/packing-strip/view';

  @override
  State<ViewStripRecordTablePanel> createState() =>
      _ViewStripRecordTablePanelState();
}

class _ViewStripRecordTablePanelState extends ViewStripRecordTableBuilder {
