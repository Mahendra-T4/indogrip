...
abstract class EditOutsourceInBuilder extends State<EditOutSourceIN> {
  ...
  initData() {
    ...
    setState(() {
      ...
      roundSizeController.text = widget.record.additionalInfo!.tapeLength
          .toString();
      ...
      selectedRoundSize = widget.record.additionalInfo!.cutMMMeterID.toString();
    });
  }
