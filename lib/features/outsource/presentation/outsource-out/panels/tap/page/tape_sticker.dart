...
class PrintTapeSticker extends StatefulWidget {
  final String rKey;

  const PrintTapeSticker({super.key, required this.rKey});
  static const String routeName = '/print-tape-Sticker';

  @override
  State<PrintTapeSticker> createState() => _PrintStickerState();
}

class _PrintStickerState extends State<PrintTapeSticker> {
  ...
  Future<void> printStickers(TapeStickerInfoModel data) async {
                  ...
                  children: [
                    ...
                    pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text(
                          'Pieces/Carton: ${data.record!.inventoryInformation!.additionalInfo!.piecesPerCarton}',
                          style: style,
                        ),
                      ],
                    ),
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                          'Width: ${data.record!.inventoryInformation!.additionalInfo!.cutMMMeter}',
                          style: style,
                        ),

                        pw.Text(
                          'Mic: ${data.record!.batchInformation!.displayMic}',
                          style: style,
                        ),
                      ],
                    ),
                    ...
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        data.record?.batchInformation?.showFor == 1
                            ? pw.Text(
                                'Length: ${data.record!.batchInformation!.displayValue}',
                                style: style,
                              )
                            : pw.Text(
                                'Weight: ${data.record!.batchInformation!.displayValue}',
                                style: style,
                              ),
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Text(
                          'Remark: ${data.record!.inventoryInformation!.remark}',
                          style: style,
                        ),
                        pw.Text(
                          'Batch Code: ${data.record!.batchInformation!.batchCode}',
                          style: style,
                        ),
                      ],
                    ),
  ...
  void initState() {
    ...
    inventoryOutBloc.add(
      ViewTapeInventoryStickerDetailsEvent(
        inventoryKey: widget.rKey.toString(),
      ),
    );
  }
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          appBar: !Responsive.isDesktop(context)
              ? MobileAppBar(context, _stateKey, 'Tape Stickers')
              : DesktopAppBar(context, _stateKey, 'Tape Stickers', false),
  ...
  Widget get contentBuilder => BlocBuilder(
    ...
    builder: (context, state) {
      switch (state.runtimeType) {
        ...
        case InventoryOutTapeStickerDetailsLoadedSuccessStatus:
          final sticker =
              (state as InventoryOutTapeStickerDetailsLoadedSuccessStatus)
                  .model;
          return Container(
        ...
        case InventoryOutTapeStickerDetailsFailedStatus:
          final errorMessage =
              (state as InventoryOutTapeStickerDetailsFailedStatus)
                  .errorMessage;
